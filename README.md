...
6. No repository variable is required for `AI_MODEL` or `AI_BASE_URL`; the workflow already uses the BigModel/GLM defaults.
...
AI_BASE_URL      Set in the workflow: https://open.bigmodel.cn/api/paas/v4.
AI_MODEL         Set in the workflow: glm-4.7-flash.
AI_DELAY_SECONDS GitHub Variable. Defaults to 12.
```

This repository is configured for BigModel GLM-4.7-Flash chat completions by default:
